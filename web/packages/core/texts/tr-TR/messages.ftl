message-cant-embed =
    Llflash, bu sayfaya gömülü Flash'ı çalıştıramadı.
...
update-ruffle = Llflash'ı güncelle
ruffle-demo = Ağ Demosu
ruffle-desktop = Masaüstü uygulaması
ruffle-wiki = Llflash wiki'yi görüntüle
enable-hardware-acceleration = Donanım hızlandırması etkin değil gibi görünüyor. Llflash çalışabilir ancak çok yavaş olabilir. Donanım hızlandırmasını nasıl etkinleştirebileceğinizi bu linkten öğrenebilirsiniz:
...
clipboard-message-title = Llflash'da kopyalama ve yapıştırma
...
error-file-protocol =
    Görünüşe göre Llflash'ı "dosya:" protokolünde çalıştırıyorsunuz.
...
error-javascript-config =
    Llflash, yanlış bir JavaScript yapılandırması nedeniyle önemli bir sorunla karşılaştı.
    ...
    Yardım için Llflash wiki'sine de başvurabilirsiniz.
error-wasm-not-found =
    Llflash gerekli ".wasm" dosya bileşenini yükleyemedi.
    Sunucu yöneticisi iseniz, lütfen dosyanın doğru bir şekilde yüklendiğinden emin olun.
    Sorun devam ederse, "publicPath" ayarını kullanmanız gerekebilir: yardım için lütfen Llflash wiki'sine başvurun.
error-wasm-mime-type =
    Llflash, başlatmaya çalışırken önemli bir sorunla karşılaştı.
    Bu web sunucusu, doğru MIME tipinde ".wasm" dosyaları sunmuyor.
    Sunucu yöneticisiyseniz, yardım için lütfen Llflash wiki'sine başvurun.
error-invalid-swf =
    Llflash istenen dosyayı ayrıştıramıyor.
    Bunun en olası nedeni, istenen dosyanın geçerli bir SWF olmamasıdır.
error-swf-fetch =
    Llflash, Flash SWF dosyasını yükleyemedi.
    Bunun en olası nedeni, dosyanın artık mevcut olmaması ve bu nedenle Llflash'ın yükleyeceği hiçbir şeyin olmamasıdır.
...
error-wasm-invalid =
    Llflash, başlatmaya çalışırken önemli bir sorunla karşılaştı.
    Görünüşe göre bu sayfada Llflash'ı çalıştırmak için eksik veya geçersiz dosyalar var.
    Sunucu yöneticisiyseniz, yardım için lütfen Llflash wiki'sine başvurun.
error-wasm-download =
    Llflash, başlatmaya çalışırken önemli bir sorunla karşılaştı.
...
error-wasm-unsupported-browser =
    Kullandığınız tarayıcı, Llflash'ın çalışması için gereken WebAssembly uzantılarını desteklemiyor.
    Lütfen desteklenen bir tarayıcıya geçin.
    Wiki'de desteklenen tarayıcıların bir listesini bulabilirsiniz.
error-javascript-conflict =
    Llflash, başlatmaya çalışırken önemli bir sorunla karşılaştı.
    Görünüşe göre bu sayfa, Llflash ile çakışan JavaScript kodu kullanıyor.
    Sunucu yöneticisiyseniz, sizi dosyayı boş bir sayfaya yüklemeyi denemeye davet ediyoruz.
error-javascript-conflict-outdated = Ayrıca sorunu giderebilecek daha yeni bir Llflash sürümü yüklemeyi de deneyebilirsiniz (mevcut yapım eskimiş: { $buildDate }).
error-csp-conflict =
    Llflash, başlatmaya çalışırken önemli bir sorunla karşılaştı.
    Bu web sunucusunun İçerik Güvenliği Politikası, gerekli ".wasm" bileşeninin çalışmasına izin vermiyor.
    Sunucu yöneticisiyseniz, yardım için lütfen Llflash wiki'sine bakın.
error-unknown =
    Llflash, bu Flash içeriğini görüntülemeye çalışırken önemli bir sorunla karşılaştı.
    { $outdated ->
        [true] Sunucu yöneticisiyseniz, lütfen Llflash'ın daha yeni bir sürümünü yüklemeyi deneyin (mevcut yapım eskimiş: { $buildDate }).
