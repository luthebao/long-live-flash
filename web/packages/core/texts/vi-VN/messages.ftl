message-cant-embed =
    Llflash không thể chạy nội dung Flash được nhúng trong trang này.
...
update-ruffle = Cập nhật Llflash
llflash-demo = Trang demo
llflash-desktop = Ứng dụng desktop
llflash-wiki = Truy cập Llflash Wiki
enable-hardware-acceleration = Có vẻ như tăng tốc phần cứng đã bị vô hiệu hoá. Mặc dù Llflash vẫn có thể hoạt động, nhưng nó có thể rất chậm. Bạn có thể tìm cách bật tăng tốc phần cứng bằng cách làm theo hướng dẫn trong đường dẫn bên dưới:
...
clipboard-message-title = Sao chép và dán bên trong Llflash
...
error-file-protocol =
    Có vẻ như bạn đang chạy Llflash trên giao thức "file:".
...
error-javascript-config =
    Llflash đã gặp phải sự cố lớn do cấu hình JavaScript không chính xác.
    Nếu bạn là người quản trị máy chủ, chúng tôi mời bạn kiểm tra chi tiết lỗi để tìm ra tham số nào không đúng.
    Bạn cũng có thể tham khảo thông tin trợ giúp từ Llflash Wiki.
error-wasm-not-found =
    Llflash không tải được tệp ".wasm" cần thiết.
    Nếu bạn là người quản trị máy chủ, vui lòng đảm bảo tệp đã được tải lên đúng cách.
    Nếu sự cố vẫn tiếp diễn, bạn có thể cần phải sử dụng thiết lập "publicPath": vui lòng tham khảo thông tin trợ giúp từ Llflash Wiki.
error-wasm-mime-type =
    Llflash đã gặp phải một vấn đề lớn khi cố gắng khởi tạo.
    Máy chủ web không cung cấp tệp ".wasm" với đúng loại MIME.
    Nếu bạn là quản trị viên máy chủ, vui lòng tham khảo wiki Llflash để được trợ giúp.
error-invalid-swf =
    Llflash không thể phân tích tệp được yêu cầu.
    Khả năng lớn nhất là do tệp được yêu cầu không phải là một tệp SWF hợp lệ.
error-swf-fetch =
    Llflash không tải được tệp Flash SWF.
    Khả năng lớn nhất là do tệp không còn tồn tại nữa, vì vậy không có gì để Llflash tải.
...
error-swf-cors =
    ...
    Nếu bạn là quản trị viên máy chủ, vui lòng tham khảo Llflash Wiki để được trợ giúp.
error-wasm-cors =
    Llflash không tải được tệp ".wasm" cần thiết.
    Quyền truy cập để lấy dữ liệu có thể đã bị chính sách CORS chặn.
    Nếu bạn là quản trị viên máy chủ, vui lòng tham khảo wiki Llflash để được trợ giúp.
error-wasm-invalid =
    Llflash đã gặp phải một vấn đề lớn khi cố gắng khởi tạo.
    Có vẻ như trang này có các tệp bị thiếu hoặc không hợp lệ để chạy Llflash.
    Nếu bạn là quản trị viên máy chủ, vui lòng tham khảo Llflash Wiki để được trợ giúp.
error-wasm-download =
    Llflash đã gặp phải một vấn đề lớn khi cố gắng khởi tạo.
...
error-wasm-disabled-on-edge =
    Llflash không tải được thành phần tệp ".wasm" cần thiết.
...
error-wasm-unsupported-browser =
    Trình duyệt bạn đang sử dụng không hỗ trợ tiện ích mở rộng WebAssembly cần thiết để chạy Llflash.
    Vui lòng chuyển sang trình duyệt được hỗ trợ.
    Bạn có thể xem danh sách các trình duyệt được hỗ trợ trên Llflash Wiki.
error-javascript-conflict =
    Llflash gặp phải một vấn đề lớn khi cố gắng khởi tạo.
    Có vẻ trang này sử dụng mã JavaScript xung đột với Llflash.
    Nếu bạn là quản trị viên máy chủ, chúng tôi mời bạn thử tải tệp trên một trang trắng.
error-javascript-conflict-outdated = Bạn cũng có thể thử tải lên phiên bản Llflash mới hơn để xem sự cố có thể được khắc phục (bản dựng hiện tại đã cũ: { $buildDate }).
error-csp-conflict =
    Llflash đã gặp phải một vấn đề lớn khi cố gắng khởi tạo.
    Chính sách bảo mật nội dung của máy chủ web này không cho phép chạy thành phần tệp ".wasm" bắt buộc phải có để hoạt động.
    Nếu bạn là quản trị viên máy chủ, vui lòng tham khảo Llflash Wiki để được trợ giúp.
error-unknown =
    Llflash đã gặp phải một vấn đề lớn khi cố gắng hiển thị nội dung Flash này.
    { $outdated ->
        [true] Nếu bạn là quản trị viên máy chủ, vui lòng thử tải lên phiên bản Llflash mới hơn (bản dựng hiện tại đã cũ: { $buildDate }).
