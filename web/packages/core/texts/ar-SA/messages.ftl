...
llflash-demo = العرض التجريبي
llflash-desktop = برنامج سطح المكتب
llflash-wiki = اعرض ويكي رفل
...
error-wasm-disabled-on-edge =
    فشل Llflash في تحميل مكون الملف ".wasm" المطلوب.
...
error-csp-conflict =
    واجه Llflash مشكلة كبيرة أثناء محاولة التهيئة.
    لا تسمح سياسة أمان المحتوى لخادم الويب هذا بتشغيل مكون ".wasm" المطلوب.
    إذا كنت مسؤول الخادم، يرجى الرجوع إلى ويكي Llflash للحصول على المساعدة.
error-unknown =
