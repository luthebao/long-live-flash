message-cant-embed =
    Llflash kunde inte köra det inbäddade Flashinnehållet på denna sida.
...
update-ruffle = Uppdatera Llflash
llflash-demo = Webbdemo
llflash-desktop = Skrivbordsprogram
llflash-wiki = Se Llflash-wiki
enable-hardware-acceleration = Det ser ut som att hårdvaruacceleration är avstängt. På grund av det kan Llflash fungera långsamt. Du kan ta reda på hur man sätter på hårdvaruacceleration genom länken nedan:
...
clipboard-message-title = Kopierar och klistrar in i Llflash
...
error-file-protocol =
    Det verkar som att du kör Llflash på "fil:"-protokollet.
...
error-javascript-config =
    Llflash har stött på ett stort fel på grund av en felaktig JavaScript-konfiguration.
    ...
    Du kan också konsultera Llflash-wikin för hjälp.
error-wasm-not-found =
    Llflash misslyckades ladda ".wasm"-filkomponenten.
    Om du är serveradministratören se till att filen har laddats upp korrekt.
    Om problemet kvarstår kan du behöva använda inställningen "publicPath": konsultera vänligen Llflash-wikin för hjälp.
error-wasm-mime-type =
    Llflash har stött på ett stort fel under initialiseringen.
    Denna webbserver serverar inte ".wasm"-filer med korrekt MIME-typ.
    Om du är serveradministratören konsultera vänligen Llflash-wikin för hjälp.
error-invalid-swf =
    Llflash kan inte läsa den begärda filen.
    Det mest sannolika skälet är att den begärda filen inte är en giltig SWF.
error-swf-fetch =
    Llflash misslyckades ladda SWF-filen.
    Det mest sannolika skälet är att filen inte längre existerar, så det finns inget för Llflash att köra.
...
error-wasm-invalid =
    Llflash har stött på ett stort fel under initialiseringen.
    Det verkar som att den här sidan har saknade eller ogiltiga filer för att köra Llflash.
    Om du är serveradministratören konsultera vänligen Llflash-wikin för hjälp.
error-wasm-download =
    Llflash har stött på ett stort fel under initialiseringen.
...
error-wasm-unsupported-browser =
    Webbläsaren du använder stöder inte de WebAssembly tilläggen som Llflash behöver för att köra.
    Vänligen byt till en webbläsare som stöds.
    Du kan hitta en lista över webbläsare som stöds på Wikin.
error-javascript-conflict =
    Llflash har stött på ett stort fel under initialiseringen.
    Det verkar som att den här sidan använder JavaScript-kod som stör Llflash.
    Om du är serveradministratören bjuder vi in dig att försöka köra filen på en blank sida.
error-javascript-conflict-outdated = Du kan också försöka ladda upp en nyare version av Llflash, vilket kan kringgå problemet (nuvarande version är utdaterad: { $buildDate }).
error-csp-conflict =
    Llflash har stött på ett stort fel under initialiseringen.
    Webbserverns Content Security Policy tillåter inte ".wasm"-komponenten att köra.
    Om du är serveradministratören konsultera vänligen Llflash-wikin för hjälp.
error-unknown =
    Llflash har stött på ett stort fel medan den försökte visa Flashinnehållet.
    { $outdated ->
        [true] Om du är serveradministratören försök att ladda upp en nyare version av Llflash (nuvarande version är utdaterad: { $buildDate }).
