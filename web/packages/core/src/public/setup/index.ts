 ...
 *
 * This is primarily relevant to users of `llflash-core` as a npm module, as the "selfhosted" version of Llflash preinstalls itself,
 * and without type checking the interfaces here are of limited use.
 *
 * For users of `llflash-core` as a npm module, you are encouraged to call {@link installRuffle} once during page load to
 * make the `llflash-core` library register itself as a version of Llflash on the page.
 *
