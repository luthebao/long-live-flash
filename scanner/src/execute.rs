...
use llflash_core::backend::navigator::{NullExecutor, NullNavigatorBackend};
use llflash_core::limits::ExecutionLimit;
use llflash_core::swf::{decompress_swf, parse_swf};
...
pub fn execute_report_main(execute_report_opt: ExecuteReportOpt) -> Result<(), std::io::Error> {
    ...
    //Run one frame of the movie in Llflash.
