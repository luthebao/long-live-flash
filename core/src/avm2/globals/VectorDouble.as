package __AS3__.vec {
    ...
    internal final dynamic class Vector$double {
        {
        ...
        public native function Vector$double(length:uint = 0, isFixed:Boolean = false);
        ...
        AS3 native function filter(callback:Function, receiver:Object = null):Vector$double;

        AS3 native function forEach(callback:Function, receiver:Object = null):void;

        AS3 native function indexOf(searchVal:Number, from:Number = 0):Number;
        ...
        AS3 native function lastIndexOf(searchVal:Number, from:Number = 2147483647):Number;
        ...
        AS3 native function splice(start:Number, deleteLen:Number, ...rest):Vector$double;
