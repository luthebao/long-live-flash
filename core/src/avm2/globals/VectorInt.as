package __AS3__.vec {
    ...
    internal final dynamic class Vector$int {
        ...
        public native function Vector$int(length:uint = 0, isFixed:Boolean = false);
        ...
        AS3 native function filter(callback:Function, receiver:Object = null):Vector$int;

        AS3 native function forEach(callback:Function, receiver:Object = null):void;

        AS3 native function indexOf(searchVal:int, from:Number = 0):Number;
        ...
        AS3 native function lastIndexOf(searchVal:int, from:Number = 2147483647):Number;
