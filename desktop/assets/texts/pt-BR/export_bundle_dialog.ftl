export-bundle-dialog-title = Exportar pacote Llflash
...
export-bundle-dialog-info-title = O que é um pacote Llflash?
export-bundle-dialog-info-description = Um pacote Llflash é um arquivo universal que contém tudo o que é necessário para executar um arquivo SWF — todos os recursos e configurações exigidos. Com um pacote, seu SWF funciona imediatamente — sem arquivos faltando, sem configurações manuais, é só conectar e usar.
