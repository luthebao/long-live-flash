export-bundle-dialog-title = Llflash 번들 내보내기
...
export-bundle-dialog-info-title = Llflash 번들이 무엇인가요?
export-bundle-dialog-info-description = Llflash 번들은 SWF 파일을 실행하는 데 필요한 애셋 및 구성에 대한 모든 요소를 포함하는 유니버셜 패키지입니다. 번들을 사용하면 누락된 파일이나 별도의 설정 필요 없이 플러그-앤-플레이 방식으로 SWF 파일을 바로 실행할 수 있습니다.
