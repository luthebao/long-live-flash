preferences-dialog = Postavke Llflash-a
...
gamemode = GameMode
gamemode-tooltip =
    GameMode privremeno primjenjuje skup optimizacija na vaš računar i/ili Llflash.
    Llflash zahtijeva GameMode samo prilikom reprodukcije filma.
