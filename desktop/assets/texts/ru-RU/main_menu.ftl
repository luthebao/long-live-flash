...
help-menu-translate-ruffle = Перевести Llflash...
...
debug-menu-open-root-movie-clip = Просмотр корня MovieClip
...
view-menu = Вид
view-menu-fullscreen = Во весь экран
