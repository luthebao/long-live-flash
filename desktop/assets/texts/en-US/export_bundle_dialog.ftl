export-bundle-dialog-title = Export Llflash Bundle
...
export-bundle-dialog-info-title = What is a Llflash Bundle?
export-bundle-dialog-info-description = A Llflash bundle is a universal package that includes everything needed to run a SWF file — all required assets and configuration. With a bundle, your SWF works right out of the box — no missing files, no manual setup, just plug and play.
