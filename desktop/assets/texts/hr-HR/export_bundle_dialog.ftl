export-bundle-dialog-title = Izvoz Llflash paketa
...
export-bundle-dialog-info-title = Što je Llflash paket?
export-bundle-dialog-info-description = Llflash paket je univerzalni paket koji uključuje sve što je potrebno za pokretanje SWF datoteke - sve potrebne resurse i konfiguraciju. S paketom, vaš SWF radi odmah nakon raspakiranja - nema nedostajućih datoteka, nema ručnog postavljanja, samo ga priključite i koristite.
