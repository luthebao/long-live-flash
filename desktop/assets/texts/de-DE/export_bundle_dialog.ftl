export-bundle-dialog-title = Llflash-Bündel exportieren
...
export-bundle-dialog-info-title = Was ist ein Llflash-Bündel?
export-bundle-dialog-info-description = Ein Llflash-Bündel ist ein universales Paket, welches alles Notwendige beinhaltet, um eine SWF-Datei auszuführen — alle benötigten Assets und die Konfiguration. Mit einem Bündel funktioniert deine SWF ohne weitere Vorbereitung — keine fehlenden Dateien, kein manuelles Einrichten, einfach "plug and play".
