...
file-menu = Soubor
file-menu-open-file = Otevřít soubor...
file-menu-open-directory = Otevřít složku...
file-menu-open-advanced = Otevřít pokročilé...
file-menu-close = Zavřít
file-menu-reload = Obnovit
file-menu-recents = Nedávné
...
help-menu-sponsor-development = Sponzorovat vývoj...
help-menu-translate-ruffle = Přeložit Llflash...
help-menu-about = O Llflash
bookmarks-menu = Záložky
bookmarks-menu-add = Přidat...
bookmarks-menu-manage = Spravovat záložky...
debug-menu = Nástroje k ladění
debug-menu-open-stage = Zobrazit informace o scéně
debug-menu-open-root-movie-clip = Zobrazit hlavní MovieClip
