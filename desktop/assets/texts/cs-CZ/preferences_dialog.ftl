preferences-dialog = Předvolby Llflash
...
gamemode = GameMode
gamemode-tooltip =
    GameMode dočasně aplikuje sadu optimalizací na váš počítač a/nebo Llflash.
    Llflash požaduje GameMode pouze při přehrávání filmu.
