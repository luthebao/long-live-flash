...
file-menu = Dosya
file-menu-open-file = Dosya aç...
file-menu-open-directory = Klasör aç...
...
controls-menu-step-once = Bir adım ilerle
controls-menu-volume = Ses kontrolleri
help-menu = Yardım
help-menu-join-discord = Discord'a katıl
help-menu-report-a-bug = Hata bildir...
help-menu-sponsor-development = Gelişimi destekle...
help-menu-translate-ruffle = Llflash'ı tercüme et...
help-menu-about = Llflash Hakkında
bookmarks-menu = Yer işaretleri
bookmarks-menu-add = Ekle...
bookmarks-menu-manage = Yer işaretlerini yönet...
debug-menu = Hata ayıklama araçları
debug-menu-open-stage = Sahne bilgilerini göster
debug-menu-open-root-movie-clip = Kök FilmKlibini görüntüle
...
debug-menu-search-display-objects = Görüntü nesnelerini ara...
view-menu = Görüntüle
