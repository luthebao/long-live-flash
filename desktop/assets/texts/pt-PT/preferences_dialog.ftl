...
gamemode = GameMode
gamemode-tooltip = O GameMode aplica temporariamente um conjunto de otimizações ao computador e/ou ao Llflash. O Llflash apenas chama o GameMode quando um filme é reproduzido.
