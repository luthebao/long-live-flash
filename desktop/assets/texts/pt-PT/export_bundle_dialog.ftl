...
export-bundle-dialog-info-description = Um pacote Llflash é um pacote universal que inclui tudo o que é necessário para executar um ficheiro SWF — todos os recursos e configurações. Com um pacote, o seu SWF funciona à primeira — sem ficheiros em falta nem ajustes manuais, prontinho a usar.
