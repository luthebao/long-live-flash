export-bundle-dialog-title = 导出 Llflash 包
...
export-bundle-dialog-info-title = 什么是 Llflash 包？
export-bundle-dialog-info-description = Llflash 包是一种通用的打包格式，包含运行 SWF 文件所需的一切——所有需要的资产和配置。使用包可以让您的 SWF 文件开箱即用——没有文件缺失，无需手动设置，即插即用。
