export-bundle-dialog-title = 匯出 Llflash 包裹
...
export-bundle-dialog-info-title = 什麼是 Llflash 包裹？
export-bundle-dialog-info-description = Llflash 包裹是一個通用封裝，包含執行 SWF 檔案所需的一切——所有必要資源與設定。使用套件後，您的 SWF 檔案可立即運作——無檔案遺漏、無需手動設定，真正實現即插即用。
