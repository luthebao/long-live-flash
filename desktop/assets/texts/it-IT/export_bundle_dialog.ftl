export-bundle-dialog-title = Esporta pacchetto Llflash
...
export-bundle-dialog-info-title = Cos'è un pacchetto Llflash?
export-bundle-dialog-info-description = Il pacchetto Llflash è un pacchetto universale che include tutto il necessario per eseguire un file SWF — quello che richiede sono le risorse e configurazioni. Con un pacchetto, il tuo file SWF funzionerà senza problemi — nessun file assente, nessuna installazione aggiuntiva, basta fare un click.
