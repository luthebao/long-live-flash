export-bundle-dialog-title = Vie Llflash-paketti
...
export-bundle-dialog-info-title = Mikä on Llflash-paketti?
export-bundle-dialog-info-description = Llflash-paketti (englanniksi bundle) on universaali paketti, joka sisältää kaiken SWF-tiedoston suorittamista varten — kaikki vaaditut tiedostot ja asetukset. Paketin avulla SWF toimii suoraan — ei puuttuvia tiedostoja, ei manuaalista määritystä, ota käyttöön sellaisenaan.
