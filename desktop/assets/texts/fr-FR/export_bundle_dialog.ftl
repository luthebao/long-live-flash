export-bundle-dialog-title = Exporter un paquet Llflash
...
export-bundle-dialog-info-title = Qu'est-ce qu'un paquet Llflash ?
export-bundle-dialog-info-description = Un paquet Llflash est une archive qui contient toutes les ressources nécessaires à l'exécution d'un fichier SWF, configuration incluse. L'utilisation d'un paquet vous permet ainsi de profiter immédiatement d'un fichier SWF, sans avoir à vous soucier de fichiers manquants ou d'une configuration manuelle.
