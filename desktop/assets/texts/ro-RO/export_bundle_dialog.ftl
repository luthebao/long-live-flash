export-bundle-dialog-title = Exportă pachet Llflash
...
export-bundle-dialog-info-title = Ce este un pachet Llflash?
export-bundle-dialog-info-description = Un pachet Llflash este un pachet universal care include tot ce trebuie pentru a rula un fișier SWF — configurația și toate resursele necesare. Cu un pachet, fișierul SWF funcționează ca din cutie — fără fișiere lipsă, fără configurare manuală, doar conectați și utilizați.
